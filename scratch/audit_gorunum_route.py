...
def audit_gorunum():
    ...
    # First load home to compile Babel and set Admin role
    ...
    # Navigate hash change to #/ayarlar/gorunum
    ...
    res = client.eval_js("""
        ...
        const paletteButtons = Array.from(document.querySelectorAll('button')).filter(b => b.innerText.includes('#') || b.innerText.includes('rounded-'));
