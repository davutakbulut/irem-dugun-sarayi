...
# Let's inspect where the Draft Panel block is in ReservationsListPage.jsx
draft_panel_code = """
                ...
                {(!draftReservations || draftReservations.length === 0) ? (
                  <div className="bg-white/60 dark:bg-brand-dark/40 p-4 rounded-2xl border border-dashed border-amber-500/30 text-center space-y-2">
                    ...
                    <button
                      ...
                      className="gold-button font-bold text-xs px-3.5 py-1.5 rounded-xl shadow-sm inline-flex items-center space-x-1"
                    >
...
print("Draft panel helper script ready.")
