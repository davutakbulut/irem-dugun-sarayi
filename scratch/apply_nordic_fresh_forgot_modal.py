...
if p1 != -1 and p2 != -1:
    new_nordic_modal_block = """{/* FORGOT PASSWORD MODAL */}
          {showForgotModal && (
                ...
                {!forgotSuccessMail ? (
                  ...
                  <div className="space-y-4 text-xs animate-fade-in">
                    ...
                    <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 p-4 rounded-2xl space-y-2 font-mono text-[11px] text-slate-700 dark:text-slate-300">
                      ...
                      <div className="pt-2 text-slate-600 dark:text-slate-300 border-t border-slate-200 dark:border-slate-800 leading-relaxed font-sans text-xs">
          ...
          """
    content = content[:p1] + new_nordic_modal_block + content[p2:]
    print("1. Applied Nordic Light fresh modal design successfully!")
