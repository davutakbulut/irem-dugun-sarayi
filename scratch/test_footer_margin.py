...
def test_footer_margin():
    ...
    res = client.eval_js("""
        ...
        const parentStyle = window.getComputedStyle(footer.parentElement);
        return {
            footerFound: true,
            ...
            isFlush: style.marginTop === '0px'
        };
    """)
    print("Footer Margin Inspection:", json.dumps(res, indent=2, ensure_ascii=False))
