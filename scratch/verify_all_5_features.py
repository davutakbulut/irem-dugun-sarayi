...
def verify_all():
    ...
    # Change to an unbooked date '2026-09-01' so conflict is false & submit button enabled
    res = client.eval_js("""
        ...
        return {
            dateSetToUnbooked: dateInput ? dateInput.value : null,
            submitAttempted: true,
            hasRedBorderHighlight: hasRedBorder,
            focusedElementId: focusedId,
            customerValidationSuccess: hasRedBorder && focusedId === 'new-cust-name-input',
            depositDefaultValue: depositVal,
    ...
    """)
    print("Verification Results:", json.dumps(res, indent=2, ensure_ascii=False))
