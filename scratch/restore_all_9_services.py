...
services_9 = [
  { "id": "s1", "order": 1, "sortOrder": 1, "name": "Gurme Yemek Servisi (Et Menü)", "category": "Catering", "price": 750, "costPrice": 290, "pricingType": "per_person", "description": "Kavurma, Et Döner, Pilav, Patates Püresi, Izgara Sebze, Tatlı, İçecek", "image": "https://images.unsplash.com/photo-1555244162-803834f70033?auto=format&fit=crop&w=600&q=80" },
...
print("1. Writing 9 services to scratch/db_services.json ...")
with open('scratch/db_services.json', 'w', encoding='utf-8') as f:
    json.dump(services_9, f, indent=2, ensure_ascii=False)

print("2. Writing 9 services to scratch/db_system_settings.json ...")
...
print("RESTORED ALL 9 SERVICES IN DATABASE SUCCESSFULLY!")
