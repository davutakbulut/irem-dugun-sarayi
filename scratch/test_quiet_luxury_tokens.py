...
def test_quiet_luxury_tokens():
    ...
    # Set Admin role & setQuiet Luxury Theme
    client.eval_js("""
    ...
    res = client.eval_js("""
        ...
        return {
            ...
            goldButtonBg: goldBtnBg,
            goldButtonBorderRadius: goldBtnRadius,
            glassPanelBorderRadius: glassRadius,
            sharpCornerZeroPx: glassRadius === '0px' && goldBtnRadius === '0px',
            quietLuxuryActive: htmlAttr === 'elite-luxury'
        };
    """)
