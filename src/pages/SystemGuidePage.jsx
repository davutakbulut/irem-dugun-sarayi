...
export function SystemGuidePageComponent({ navigateTo, activeRole, themeColor, menuLayout }) {
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="glass-panel p-6 rounded-3xl border border-slate-200 dark:border-brand-border space-y-4">
                  ...
                  <p className="text-xs text-slate-600 dark:text-gray-300 leading-relaxed">
                    Uygulamamızdaki tüm JSX bileşenleri <code className="bg-slate-100 dark:bg-brand-dark px-2 py-1 rounded font-mono">scratch/build_precompiled.py</code> betiği ile Babel standalone kullanılarak önceden derlenir ve <code className="bg-slate-100 dark:bg-brand-dark px-2 py-1 rounded font-mono">src/app.compiled.js?v=1785541432?v=1785541295</code> dosyasına kaydedilir. Yükleme scripti <code className="bg-slate-100 dark:bg-brand-dark px-2 py-1 rounded font-mono">src/app.compiled.js?v=1785541432?v=1785541295?v=timestamp</code> parametresiyle çağrılarak tarayıcının her zaman taze JavaScript çalıştırması garanti altına alınır.
                  </p>
                </div>
              </div>
            )}
