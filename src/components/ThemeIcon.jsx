...
const NordicSvgMap = {
  ...
  whatsapp: (props) => (
    <svg className={props.className || "w-4 h-4 inline-block text-white stroke-white"} fill="none" stroke="white" viewBox="0 0 24 24" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z" />
      <path d="M16 14c-.3.2-1.8 1-2 .9-.2 0-.4-.1-.7-.3-.8-.5-1.5-1.2-2-2-.2-.3-.3-.5-.3-.7.1-.2.9-1.7.9-2 0-.2-.1-.4-.2-.5s-.8-1.9-1-2.4c-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.4.1-.6.3-.7.7-1 1.6-1 2.5 0 1.5.8 3 2.1 4.3 1.3 1.3 2.8 2.1 4.3 2.1.9 0 1.8-.3 2.5-1 .2-.2.3-.4.3-.6v-.5c0-.2-.1-.4-.4-.6z" />
    </svg>
  ),
  alert: (props) => (
    <svg className={props.className || "w-4 h-4 inline-block"} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.75">
...
export function WhatsAppIcon({ className = "w-4 h-4 shrink-0" }) {
  return (
    <svg className={`text-white stroke-white ${className}`} fill="none" stroke="white" viewBox="0 0 24 24" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z" />
      <path d="M16 14c-.3.2-1.8 1-2 .9-.2 0-.4-.1-.7-.3-.8-.5-1.5-1.2-2-2-.2-.3-.3-.5-.3-.7.1-.2.9-1.7.9-2 0-.2-.1-.4-.2-.5s-.8-1.9-1-2.4c-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.4.1-.6.3-.7.7-1 1.6-1 2.5 0 1.5.8 3 2.1 4.3 1.3 1.3 2.8 2.1 4.3 2.1.9 0 1.8-.3 2.5-1 .2-.2.3-.4.3-.6v-.5c0-.2-.1-.4-.4-.6z" />
    </svg>
  );
