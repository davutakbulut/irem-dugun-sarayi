...
// Unified SVG Icon Map for Nordic Clarity & Scandinavian Minimal (STRICT ZERO EMOJI) - 52 Icons
export const NordicSvgMap = {
  ...
  sparkles: (props) => <svg className={props.className || "w-4 h-4 inline-block"} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.75"><path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4M4 19h4M13 3l2.5 5.5L21 11l-5.5 2.5L13 19l-2.5-5.5L5 11l5.5-2.5L13 3z" /></svg>,
...
export const ThemeConceptEmojis = {
...
export function ThemeIcon({ icon, fallbackEmoji, activeTheme, className = "w-4 h-4" }) {
  ...
  const isVectorTheme = rawTheme === 'nordic-light' || rawTheme === 'nordic_light' || rawTheme === 'apple' || rawTheme === 'apple-light';
